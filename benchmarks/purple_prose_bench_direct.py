"""Simple benchmark for the Purple Prose Detox Filter using direct imports."""
...
# Add the specific paths to our modules
...
def run_benchmark() -> None:
    ...
    for size in test_sizes:
        ...
        cleaned_text, metrics = pipeline.process(text, episode_id=f"bench_{size}")
...
def test_consistency() -> None:
    ...
    for i in range(5):
        pipeline = ProseDetoxPipeline()
        cleaned_text, metrics = pipeline.process(text, episode_id=f"consistency_{i}")
