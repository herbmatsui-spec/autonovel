...
def generate_di_svg() -> str:
    ...
    providers = {
        ...
        "llm_factory": {
            ...
            "deps": ["LLMProviderFactory", "genai_client", "cooldown"],
        },
        "semantic_cache": {
            "type": "SingletonProvider",
            "deps": ["SemanticCacheManager", "vector_store", "llm_client"],
        },
        ...
        "auditor": {
            "type": "SingletonProvider",
            "deps": ["LogicalAuditor", "repo", "pm", "llm", "ctx_mgr"],
        },
        "marketing": {"type": "SingletonProvider", "deps": ["MarketingAgent", "repo", "pm", "llm"]},
        "bible_generator": {
            "type": "SingletonProvider",
            "deps": ["WorldBibleGenerator", "repo", "llm", "pm", "marketing", "auditor"],
        },
        "plot_expander": {
            "type": "SingletonProvider",
            "deps": ["PlotExpander", "repo", "llm", "pm", "auditor"],
        },
        "planner": {
            "type": "SingletonProvider",
            "deps": [
        ...
        "narrative": {
            "type": "SingletonProvider",
            "deps": ["NarrativeController", "llm", "repo", "pm", "ctx_mgr", "validator", "auditor"],
        },
        "critique": {"type": "SingletonProvider", "deps": ["CritiqueAgent", "repo", "pm", "llm"]},
        "style_rag": {
            "type": "SingletonProvider",
            "deps": ["StyleRagManager", "genai_client", "repo"],
        },
        "writer": {
            "type": "SingletonProvider",
            "deps": [
        ...
        json.dump(
            {
                "providers": {
                    ...
                    for k, v in {
                        ...
                        "genai_client": {
                            "type": "SingletonProvider",
                            "deps": ["create_genai_client", "api_key"],
                        },
                        "llm_factory": {
                            "type": "SingletonProvider",
                            "deps": ["LLMProviderFactory", "genai_client", "cooldown"],
                        ...
                        "llm": {
                            "type": "SingletonProvider",
                            "deps": ["LLMGenerateResultProxy", "llm_factory"],
                        },
                        "connection_pipeline": {
                            "type": "SingletonProvider",
                            "deps": ["_get_connection_pipeline"],
                        },
                        "repo": {"type": "SingletonProvider", "deps": ["DataRepository", "db"]},
                        "uow": {"type": "FactoryProvider", "deps": ["UnitOfWork", "db"]},
                        "pm": {"type": "SingletonProvider", "deps": ["PromptManager"]},
                        ...
                        "marketing": {
                            "type": "SingletonProvider",
                            "deps": ["MarketingAgent", "repo", "pm", "llm"],
                        },
                        "bible_generator": {
                            "type": "SingletonProvider",
                            "deps": [
                        ...
                        "critique": {
                            "type": "SingletonProvider",
                            "deps": ["CritiqueAgent", "repo", "pm", "llm"],
                        },
                        "style_rag": {
                            "type": "SingletonProvider",
                            "deps": ["StyleRagManager", "genai_client", "repo"],
