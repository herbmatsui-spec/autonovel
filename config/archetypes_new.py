...
WIZARD_GENRE_OPTIONS = ["ファンタジー", "SF", "現代", "歴史", "官能/ロマンス", "その他"]
...
EASY_GENRES = {
    "⚔️ 追放ざまぁ": {
        "genre": "ファンタジー",
        "archetype": "overcoming_the_monster",
    ...
    "🌸 純愛官能": {
        "genre": "官能/ロマンス",
        "archetype": "pure_love_erotic",
        "desc": "触覚・呼吸・匂いを主軸に、情緒と余韻を重んじる純愛官能ストーリー",
        "nsfw_only": True,
    },
    "💜 背徳官能": {
        "genre": "官能/ロマンス",
        "archetype": "taboo_erotic",
        "desc": "タブーに挑む心理葛藤と背徳感を重視した大人向けの心理劇",
        "nsfw_only": True,
    },
    "✨ 幻想官能": {
        "genre": "官能/ロマンス",
        "archetype": "fantasy_erotic",
        "desc": "異種族の身体感覚と魔法を交えたファンタジー官能描写",
        "nsfw_only": True,
    },
    "💑 夫婦官能": {
        "genre": "官能/ロマンス",
        "archetype": "married_erotic",
        "desc": "長年連れ添った夫婦の親密性の深化と日常の情緒",
        "nsfw_only": True,
    },
}
