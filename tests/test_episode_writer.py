...
class TestEpisodeWriter:
    ...
    async def test_write_first_episode(self, writer):
        """第1話執筆テスト"""
        context = {"ep_num": 1, "is_first": True, "is_last": False, "target_word_count": 3000}
    ...
    async def test_write_fallback_mode(self, writer):
        """フォールバックモードテスト"""
        context = {"ep_num": 5, "is_first": False, "is_last": True, "target_word_count": 3000}
    ...
    def test_word_count_estimate(self, writer):
        """文字数見積テスト"""
        context = {"target_word_count": 3000, "is_first": False, "is_last": False}
    ...
    def test_word_count_estimate_first(self, writer):
        """文字数見積テスト（第1話）"""
        context = {"target_word_count": 3000, "is_first": True, "is_last": False}
    ...
    def test_word_count_estimate_last(self, writer):
        """文字数見積テスト（最終話）"""
        context = {"target_word_count": 3000, "is_first": False, "is_last": True}
