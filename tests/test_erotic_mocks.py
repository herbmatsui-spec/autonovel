...
MOCK_FILES = {
    "mock_erotic_pure_love.md": {"expected_intensity": 3, "expected_phases": {"BUILD": 1, "PEAK": 1, "AFTERGLOW": 1}},
    "mock_erotic_taboo.md": {"expected_intensity": 4, "expected_phases": {"BUILD": 1, "PEAK": 1, "AFTERGLOW": 1}},
    "mock_erotic_extreme.md": {"expected_intensity": 5, "expected_phases": {"BUILD": 1, "PEAK": 1, "AFTERGLOW": 1}},
}
...
class TestEroticMocks:
    ...
    @pytest.mark.parametrize("filename,expected_intensity", [
