...
_DEFAULT_STYLE_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "style_military_rational": {
        ...
        "metaphor_dna":   "硝煙、機械 of 駆動音、冷たい金属。損耗率、確率の数値化。",
    ...
    "style_overlord": {
        "name":           "勘違い・魔王（オバロ風）",
        "instruction":    "【指針】絶対支配者としての外面と、小心者の内面のギャップを描け。配下の過剰な崇拝と残酷な蹂虙描写を重厚に記述せよ。",
        "dialogue_ratio": "40%",
    ...
    "style_shadow_ruler": {
        "name":           "冷徹・策略（影 of 支配者）",
        "instruction":    "【指針】観察者としての冷徹な視点。表舞台の茶番を見下ろし、糸を引く黒幕としてのユーモアを排除し、淡々と、しかし確実に記述せよ。",
        "dialogue_ratio": "40%",
