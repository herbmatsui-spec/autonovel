...
if not hasattr(BookDbModel, 'cumulative_stress'):
    setattr(BookDbModel, 'cumulative_stress', property(lambda self: getattr(self, 'cumulative_tension', 0)))
if not hasattr(BookDbModel, 'cumulative_tension'):
    setattr(BookDbModel, 'cumulative_tension', property(lambda self: getattr(self, 'cumulative_stress', 0)))
