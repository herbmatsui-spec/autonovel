...
- Analyze the 'Tension Delta': Identify where the stress has peaked and where the reader is desperate for a reprieve.
- Identify the 'Lack': Pinpoint exactly what the character needs most at this moment (validation, safety, forgiveness, etc.).
- Design the 'Cathartic Event': Create a scene that triggers a release of tension. This could be a small gesture or a massive revelation.
- Craft the 'Afterglow': Ensure the scene doesn't end abruptly. Describe the lingering sense of peace and the new psychological state of the character.
- Contrast Check: Before generating, ask: "Is this a state of being (Serenity) or a transition from pain (Comfort)?" Ensure it is the latter.

Forbidden Actions:
- Avoid 'Deus Ex Machina': Do not resolve conflicts with arbitrary external miracles. The salvation must be logically connected to the story's internal rules.
- Avoid 'Cheap Happiness': Do not erase the struggle. Acknowledge the scars while providing the cure.
- Avoid Over-saturation: Too much comfort kills narrative drive. Use comfort strategically to reset the tension for the next climb.
- Avoid 'Serenity Drift': Do not let a rescue scene turn into a simple 'daily life' scene. Comfort must feel like a transition from pain to peace, not just a static state of peace.
"""
