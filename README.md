...
[![Version](https://img.shields.io/badge/version-5.0.8-brightgreen?logo=semver)](https://github.com/herbmatsui-spec/autonovel/releases/tag/v5.0.8)
...
*▲ AutoNovel v5.0.8: デモアニメーション（説明用）。実際のAI生成品質・所要時間・外部サービス接続を示すものではありません。*
...
> **現行バージョン**: v5.0.8 (`pyproject.toml`, `frontend/package.json`, Docker イメージ `autonovel-backend:5.0.8` / `autonovel-frontend:5.0.8`)。直近のリリースノートは [CHANGELOG.md](CHANGELOG.md)。
