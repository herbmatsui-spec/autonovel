"""
context_builder.py - ����� ��� ��� � ��� � � 執�������筆コンテキスト構�������築ユーティリティ
"""
    ...
    def _build_dialogue_profiles(self, chars: list[Any]) -> dict[str, str]:
        ...
        for char in chars:
            ...
            if reg.get("catchphrase"):
                parts.append(f"口�������癖: {reg['catchphrase']}")
        ...
        if (
            ...
            try:
                ...
                if bible and hasattr(bible, "arcs"):
                    ...
                    arcs = bible.get("arcs", [])
                results = await self.agent._plot_expander.expand_plots(
                    book_id=book_id,
