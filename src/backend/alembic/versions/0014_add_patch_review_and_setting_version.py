...
def upgrade() -> None:
    ...
    op.create_unique_constraint(
        "uq_setting_versions_book_ver", "setting_versions", ["book_id", "version_number"]
    )
    op.create_index("idx_setting_versions_book", "setting_versions", ["book_id"])


def downgrade() -> None:
    op.drop_index("idx_setting_versions_book", table_name="setting_versions")
    op.drop_constraint("uq_setting_versions_book_ver", "setting_versions", type_="unique")
    op.drop_table("setting_versions")

    op.drop_index("idx_setting_deltas_merged", table_name="setting_deltas")
    op.drop_index("idx_setting_deltas_book_field", table_name="setting_deltas")
    op.drop_table("setting_deltas")

    op.drop_index("idx_patch_reviews_status", table_name="patch_reviews")
    op.drop_index("idx_patch_reviews_book_ep", table_name="patch_reviews")
