...
def upgrade() -> None:
    ...
    op.add_column(
        "plot",
        sa.Column("emotional_resonance_score", sa.Integer(), server_default="0", nullable=True),
    )
    op.add_column(
        "plot", sa.Column("thematic_depth_score", sa.Integer(), server_default="0", nullable=True)
    )
    op.add_column(
        "plot", sa.Column("literary_beauty_score", sa.Integer(), server_default="0", nullable=True)
    )
